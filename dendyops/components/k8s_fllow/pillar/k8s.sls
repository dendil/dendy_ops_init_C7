...
#设置Master的IP地址(必须修改)
MASTER_IP_M1: "192.168.1.11"
MASTER_IP_M2: "192.168.1.13"
MASTER_IP_M3: "192.168.1.8"
#设置Master的HOSTNAME完整的FQDN名称(必须修改)
MASTER_H1: "master1.caojie.top"
MASTER_H2: "master2.caojie.top"
MASTER_H3: "admin1.caojie.top"
...
#设置ETCD集群初始化列表（必须修改）
ETCD_CLUSTER: "etcd-node1=http://192.168.1.11:2380,etcd-node2=http://192.168.1.13:2380,etcd-node3=http://192.168.1.8:2380"
